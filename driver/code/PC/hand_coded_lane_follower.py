...
def detect_edges(frame):
    ...
    #lower_yellow = np.array([25, 70, 170])
    # Worked well with the several turn video
    lower_yellow = np.array([23, 73, 170])
    ...
    try:
        ...
        while cap.isOpened():
            ...
            if i < total_frames:
                ...
                # !!!!!We can hack here if we find the angles are constantly below 90 on a straight lane.
